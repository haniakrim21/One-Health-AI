  ...
  return (
    <footer className='relative shrink-0 grow-0 px-12 py-2'>
      ...
      <div className='mt-3 flex items-center gap-2'>
        <CustomLink href='https://github.com/haniakrim21'>
          <RiGithubFill className='h-5 w-5 text-text-tertiary' />
        </CustomLink>

        <CustomLink href='https://www.linkedin.com/in/haniibrahimakrim/'>
          <RiLinkedinFill className='h-5 w-5 text-text-tertiary' />
        </CustomLink>
      </div>
    </footer>
  )
