const translation = {
  common: {
    ...
    listening: 'الاستماع',
    chooseStartNodeToRun: 'اختر عقدة البدء للتشغيل',
    ...
    ImageUploadLegacyTip: 'يمكنك الآن إنشاء متغيرات نوع الملف في نموذج البدء. لن ندعم ميزة تحميل الصور في المستقبل. ',
    fileUploadTip: 'تم ترقية ميزات تحميل الصور إلى تحميل الملفات. ',
    featuresDocLink: 'اعرف المزيد',
    ...
    exitVersions: 'الخروج من الإصدارات',
    ...
    notRunning: 'لا يعمل بعد',
    previewPlaceholder: 'أدخل المحتوى في المربع أدناه لبدء تصحيح أخطاء روبوت الدردشة',
    effectVarConfirm: {
      title: 'إزالة المتغير',
    ...
    workflowAsToolTip: 'مطلوب إعادة تكوين الأداة بعد تحديث سير العمل.',
    ...
    syncingData: 'مزامنة البيانات، بضع ثوانٍ فقط.',
    ...
    parallelTip: {
      ...
      depthLimit: 'حد طبقة التداخل المتوازي لـ {{num}} طبقات',
    },
    disconnect: 'قطع الاتصال',
    jumpToNode: 'الانتقال إلى هذه العقدة',
  ...
  publishLimit: {
    ...
    startNodeTitleSuffix: 'لفتح مشغلات غير محدودة لكل سير عمل',
    startNodeDesc: 'لقد وصلت إلى حد مشغلين لكل سير عمل لهذه الخطة. قم بالترقية لنشر سير العمل هذا.',
  },
  env: {
    envPanelTitle: 'متغيرات البيئة',
    envDescription: 'يمكن استخدام متغيرات البيئة لتخزين المعلومات الخاصة وبيانات الاعتماد. وهي للقراءة فقط ويمكن فصلها عن ملف DSL أثناء التصدير.',
    ...
    modal: {
      ...
      value: 'القيمة',
      valuePlaceholder: 'قيمة البيئة',
      secretTip: 'يستخدم لتحديد المعلومات أو البيانات الحساسة، مع تكوين إعدادات DSL لمنع التسرب.',
      description: 'الوصف',
      descriptionPlaceholder: 'صف المتغير',
    },
    export: {
  ...
  globalVar: {
    ...
    description: 'متغيرات النظام هي متغيرات عالمية يمكن الإشارة إليها بواسطة أي عقدة دون توصيل عندما يكون النوع صحيحًا، مثل معرف المستخدم النهائي ومعرف سير العمل.',
    fieldsDescription: {
      conversationId: 'معرف المحادثة',
      dialogCount: 'عدد المحادثات',
      userId: 'معرف المستخدم',
      triggerTimestamp: 'طابع بدء التطبيق',
      appId: 'معرف التطبيق',
  ...
  sidebar: {
    ...
    exportWarningDesc: 'سيؤدي هذا إلى تصدير النسخة المحفوظة الحالية من سير العمل الخاص بك. إذا كان لديك تغييرات غير محفوظة في المحرر، يرجى حفظها أولاً باستخدام خيار التصدير في لوحة سير العمل.',
  },
  chatVariable: {
    panelTitle: 'متغيرات المحادثة',
    panelDescription: 'تستخدم متغيرات المحادثة لتخزين المعلومات التفاعلية التي يحتاج LLM إلى تذكرها، بما في ذلك سجل المحادثة والملفات المحملة وتفضيلات المستخدم. وهي للقراءة والكتابة. ',
    docLink: 'قم بزيارة وثائقنا لمعرفة المزيد.',
    button: 'إضافة متغير',
    modal: {
  ...
  changeHistory: {
    ...
    stepBackward_one: '{{count}} خطوة للوراء',
    stepBackward_other: '{{count}} خطوات للوراء',
    stepForward_one: '{{count}} خطوة للأمام',
    stepForward_other: '{{count}} خطوات للأمام',
    sessionStart: 'بدء الجلسة',
    currentState: 'الحالة الحالية',
    nodeTitleChange: 'تغير عنوان العقدة',
    nodeDescriptionChange: 'تغير وصف العقدة',
    nodeDragStop: 'تم نقل العقدة',
    nodeChange: 'تغيرت العقدة',
    nodeConnect: 'تم توصيل العقدة',
    nodePaste: 'تم لصق العقدة',
    nodeDelete: 'تم حذف العقدة',
    nodeAdd: 'تمت إضافة العقدة',
    nodeResize: 'تم تغيير حجم العقدة',
    noteAdd: 'تمت إضافة ملاحظة',
    noteChange: 'تغيرت الملاحظة',
  ...
  errorMsg: {
    ...
    fields: {
      ...
      code: 'الكود',
      model: 'النموذج',
      rerankModel: 'نموذج إعادة ترتيب مكون',
      visionVariable: 'متغير الرؤية',
    },
    invalidVariable: 'متغير غير صالح',
    noValidTool: '{{field}} لم يتم تحديد أداة صالحة',
    toolParameterRequired: '{{field}}: المعلمة [{{param}}] مطلوبة',
    startNodeRequired: 'يرجى إضافة عقدة بدء أولاً قبل {{operation}}',
  },
  error: {
    startNodeRequired: 'يرجى إضافة عقدة بدء أولاً قبل {{operation}}',
    operations: {
      connectingNodes: 'توصيل العقد',
      addingNodes: 'إضافة عقد',
  ...
  tabs: {
    ...
    'start': 'بدء',
    'blocks': 'عقد',
    'searchTool': 'بحث عن أداة',
    'searchTrigger': 'بحث عن مشغلات...',
    ...
    'startDisabledTip': 'عقدة المشغل وعقدة إدخال المستخدم متنافيتان.',
  },
  blocks: {
    'start': 'إدخال المستخدم',
    'originalStartNode': 'عقدة البدء الأصلية',
    'end': 'إخراج',
    'answer': 'إجابة',
    'llm': 'LLM',
  ...
  blocksAbout: {
    ...
    'if-else': 'يسمح لك بتقسيم سير العمل إلى فرعين بناءً على شروط إذا/وإلا',
    'code': 'تنفيذ قطعة من كود Python أو NodeJS لتنفيذ منطق مخصص',
    'template-transform': 'تحويل البيانات إلى سلسلة باستخدام صيغة قالب Jinja',
    ...
    'assigner': 'تستخدم عقدة تعيين المتغير لتعيين قيم للمتغيرات القابلة للكتابة (مثل متغيرات المحادثة).',
    ...
    'loop': 'تنفيذ حلقة من المنطق حتى يتم استيفاء شرط الإنهاء أو الوصول إلى الحد الأقصى لعدد الحلقات.',
    'loop-end': 'مكافئ لـ "break". هذه العقدة ليس لها عناصر تكوين. عندما يصل جسم الحلقة إلى هذه العقدة، تنتهي الحلقة.',
    'parameter-extractor': 'استخدام LLM لاستخراج المعلمات الهيكلية من اللغة الطبيعية لاستدعاءات الأدوات أو طلبات HTTP.',
    'document-extractor': 'يستخدم لتحليل المستندات المحملة إلى محتوى نصي يسهل فهمه بواسطة LLM.',
    'list-operator': 'يستخدم لتصفية أو فرز محتوى المصفوفة.',
    ...
    'trigger-webhook': 'يستقبل مشغل Webhook دفعات HTTP من أنظمة تابعة لجهات خارجية لتشغيل سير العمل تلقائيًا.',
    'trigger-plugin': 'مشغل تكامل تابع لجهة خارجية يبدأ سير العمل من أحداث منصة خارجية',
  },
  difyTeam: 'فريق One Health',
  operator: {
    zoomIn: 'تكبير',
    zoomOut: 'تصغير',
  ...
  panel: {
    ...
    helpLink: 'عرض الوثائق',
    openWorkflow: 'فتح سير العمل',
    about: 'حول',
    createdBy: 'تم الإنشاء بواسطة ',
    nextStep: 'الخطوة التالية',
    addNextStep: 'إضافة الخطوة التالية في سير العمل هذا',
    ...
    goTo: 'الذهاب إلى',
    startNode: 'عقدة البدء',
    organizeBlocks: 'تنظيم العقد',
    change: 'تغيير',
    optional: '(اختياري)',
    maximize: 'تكبير اللوحة',
    minimize: 'الخروج من ملء الشاشة',
    scrollToSelectedNode: 'التمرير إلى العقدة المحددة',
  ...
  nodes: {
    common: {
      ...
      errorHandle: {
        ...
        tip: 'استراتيجية معالجة الاستثناءات، يتم تشغيلها عندما تواجه العقدة استثناءً.',
        none: {
          title: 'لا شيء',
        ...
        failBranch: {
          ...
          customize: 'انتقل إلى اللوحة لتخصيص منطق فرع الفشل.',
          customizeTip: 'عند تنشيط فرع الفشل، لن تنهي الاستثناءات التي تطرحها العقد العملية. بدلاً من ذلك، ستنفذ تلقائيًا فرع الفشل المحدد مسبقًا، مما يسمح لك بتقديم رسائل خطأ أو تقارير أو إصلاحات أو إجراءات تخطي بمرونة.',
          inLog: 'استثناء العقدة، سينفذ تلقائيًا فرع الفشل. سيعيد إخراج العقدة نوع خطأ ورسالة خطأ ويمررها إلى المصب.',
        },
        partialSucceeded: {
      ...
      retry: {
        ...
        retryTimes: 'إعادة المحاولة {{times}} مرات عند الفشل',
        retrying: 'جارٍ إعادة المحاولة...',
        retrySuccessful: 'نجحت إعادة المحاولة',
        retryFailed: 'فشلت إعادة المحاولة',
        retryFailedTimes: 'فشلت {{times}} محاولات',
        times: 'مرات',
        ms: 'مللي ثانية',
        retries: '{{num}} محاولات',
      },
    ...
    llm: {
      ...
      prompt: 'موجه',
      roleDescription: {
        system: 'إعطاء تعليمات عالية المستوى للمحادثة',
        user: 'تقديم تعليمات أو استفسارات أو أي إدخال نصي للنموذج',
      ...
      reasoningFormat: {
        ...
        tooltip: 'استخراج المحتوى من علامات التفكير وتخزينه في حقل reasoning_content.',
      },
      jsonSchema: {
        title: 'مخطط الإخراج الهيكلي',
        instruction: 'تعليمات',
        promptTooltip: 'تحويل وصف النص إلى هيكل مخطط JSON موحد.',
        ...
        generating: 'جارٍ توليد مخطط JSON...',
        generatedResult: 'النتيجة المولدة',
        resultTip: 'هذه هي النتيجة المولدة. إذا لم تكن راضيًا، يمكنك العودة وتعديل الموجه الخاص بك.',
        back: 'عودة',
        regenerate: 'إعادة التوليد',
        apply: 'تطبيق',
        doc: 'اعرف المزيد عن الإخراج الهيكلي',
        resetDefaults: 'إعادة تعيين',
        required: 'مطلوب',
        addField: 'إضافة حقل',
        addChildField: 'إضافة حقل فرعي',
        showAdvancedOptions: 'عرض الخيارات المتقدمة',
        stringValidations: 'تحقق من صحة السلسلة',
        fieldNamePlaceholder: 'اسم الحقل',
        descriptionPlaceholder: 'إضافة وصف',
        warningTips: {
          saveSchema: 'يرجى إنهاء تحرير الحقل الحالي قبل حفظ المخطط',
        },
      },
    },
    knowledgeRetrieval: {
      ...
      metadata: {
        ...
        tip: 'تصفية البيانات الوصفية هي عملية استخدام سمات البيانات الوصفية (مثل العلامات أو الفئات أو أذونات الوصول) لتحسين والتحكم في استرداد المعلومات ذات الصلة داخل النظام.',
        options: {
          disabled: {
            title: 'معطل',
          ...
          automatic: {
            title: 'تلقائي',
            subTitle: 'توليد شروط تصفية البيانات الوصفية تلقائيًا بناءً على استعلام المستخدم',
            desc: 'توليد شروط تصفية البيانات الوصفية تلقائيًا بناءً على متغير الاستعلام',
          },
          manual: {
            title: 'يدوي',
    ...
    http: {
      inputVars: 'متغيرات الإدخال',
      api: 'API',
      apiPlaceholder: 'أدخل URL، اكتب \'/\' لإدراج متغير',
      extractListPlaceholder: 'أدخل فهرس عنصر القائمة، اكتب \'/\' لإدراج متغير',
      notStartWithHttp: 'يجب أن يبدأ API بـ http:// أو https://',
      key: 'المفتاح',
      type: 'النوع',
      value: 'القيمة',
      bulkEdit: 'تعديل مجمع',
      keyValueEdit: 'تعديل مفتاح-قيمة',
      headers: 'الرؤوس',
      params: 'المعلمات',
      body: 'الجسم',
      ...
      curl: {
        ...
        placeholder: 'الصق سلسلة cURL هنا',
      },
      verifySSL: {
        title: 'التحقق من شهادة SSL',
        warningTooltip: 'لا يوصى بتعطيل التحقق من SSL لبيئات الإنتاج. يجب استخدام هذا فقط في التطوير أو الاختبار، لأنه يجعل الاتصال عرضة لتهديدات الأمان مثل هجمات الرجل في المنتصف.',
      },
    },
    code: {
      inputVars: 'متغيرات الإدخال',
      ...
      advancedDependenciesTip: 'أضف بعض التبعيات المحملة مسبقًا التي تستغرق وقتًا أطول للاستهلاك أو ليست مدمجة افتراضيًا هنا',
      searchDependencies: 'بحث في التبعيات',
      syncFunctionSignature: 'مزامنة توقيع الوظيفة مع الكود',
    },
    templateTransform: {
      inputVars: 'متغيرات الإدخال',
      code: 'الكود',
    ...
    ifElse: {
      ...
      elseDescription: 'يستخدم لتحديد المنطق الذي يجب تنفيذه عندما لا يتم استيفاء شرط إذا.',
      and: 'و',
      or: 'أو',
      operator: 'المشغل',
      notSetVariable: 'يرجى تعيين المتغير أولاً',
      comparisonOperator: {
        'contains': 'يحتوي على',
      ...
      conditionNotSetup: 'الشرط لم يتم إعداده',
      selectVariable: 'حدد متغير...',
    ...
    variableAssigner: {
      ...
      noVarTip: 'أضف المتغيرات المراد تعيينها',
      type: {
        string: 'سلسلة',
        number: 'رقم',
        object: 'كائن',
    ...
    tool: {
      ...
      outputVars: {
        text: 'محتوى مولد بواسطة الأداة',
        files: {
          title: 'ملفات مولدة بواسطة الأداة',
          type: 'نوع الدعم. الآن يدعم الصور فقط',
          transfer_method: 'طريقة النقل. القيمة هي remote_url أو local_file',
          url: 'رابط الصورة',
          upload_file_id: 'معرف ملف التحميل',
        },
        json: 'json مولد بواسطة الأداة',
      },
    },
    triggerPlugin: {
      authorized: 'مفوض',
      ...
      selectSubscription: 'تحديد اشتراك',
      ...
      parametersDescription: 'تكوين معلمات وخصائص المشغل',
      configurationComplete: 'اكتمل التكوين',
      configurationCompleteDescription: 'تم تكوين المشغل الخاص بك بنجاح',
      configurationCompleteMessage: 'تكوين المشغل الخاص بك مكتمل الآن وجاهز للاستخدام.',
      parameters: 'المعلمات',
      properties: 'الخصائص',
    ...
    parameterExtractor: {
      ...
      outputVars: {
        isSuccess: 'هل نجح. عند النجاح تكون القيمة 1، وعند الفشل تكون القيمة 0.',
      ...
      addExtractParameterContent: {
        ...
        required: 'مطلوب',
        requiredContent: 'يستخدم المطلوب فقط كمرجع لاستنتاج النموذج، وليس للتحقق الإلزامي من إخراج المعلمة.',
      },
      extractParametersNotSet: 'معلمات الاستخراج لم يتم إعدادها',
      instruction: 'تعليمات',
      instructionTip: 'أدخل تعليمات إضافية لمساعدة مستخرج المعلمات على فهم كيفية استخراج المعلمات.',
      advancedSetting: 'إعداد متقدم',
      reasoningMode: 'وضع التفكير',
      reasoningModeTip: 'يمكنك اختيار وضع التفكير المناسب بناءً على قدرة النموذج على الاستجابة للتعليمات لاستدعاء الوظائف أو المطالبات.',
    },
    iteration: {
      ...
      MaxParallelismDesc: 'يستخدم الحد الأقصى للتوازي للتحكم في عدد المهام التي يتم تنفيذها في وقت واحد في تكرار واحد.',
      errorResponseMethod: 'طريقة الاستجابة للخطأ',
      ErrorMethod: {
        operationTerminated: 'تم الإنهاء',
        continueOnError: 'متابعة عند الخطأ',
        removeAbnormalOutput: 'إزالة الإخراج غير الطبيعي',
      },
      answerNodeWarningDesc: 'تحذير الوضع المتوازي: قد تتسبب عقد الإجابة وتعيينات متغيرات المحادثة وعمليات القراءة/الكتابة المستمرة داخل التكرارات في حدوث استثناءات.',
      flattenOutput: 'تسطيح الإخراج',
      flattenOutputDesc: 'عند التمكين، إذا كانت جميع مخرجات التكرار مصفوفات، فسيتم تسطيحها في مصفوفة واحدة. عند التعطيل، ستحافظ المخرجات على هيكل مصفوفة متداخل.',
    },
    loop: {
      ...
      loopMaxCountError: 'يرجى إدخال حد أقصى صالح لعدد الحلقات، يتراوح من 1 إلى {{maxCount}}',
      errorResponseMethod: 'طريقة الاستجابة للخطأ',
      ErrorMethod: {
        operationTerminated: 'تم الإنهاء',
        continueOnError: 'متابعة عند الخطأ',
    ...
    agent: {
      strategy: {
        ...
        searchPlaceholder: 'بحث عن استراتيجية الوكيل',
      },
      learnMore: 'اعرف المزيد',
      pluginNotInstalled: 'هذه الإضافة غير مثبتة',
      pluginNotInstalledDesc: 'تم تثبيت هذه الإضافة من GitHub. يرجى الانتقال إلى الإضافات لإعادة التثبيت',
      linkToPlugin: 'رابط إلى الإضافات',
      pluginInstaller: {
        install: 'تثبيت',
      ...
      modelNotInMarketplace: {
        ...
        desc: 'تم تثبيت هذا النموذج من مستودع محلي أو GitHub. يرجى استخدامه بعد التثبيت.',
        manageInPlugins: 'إدارة في الإضافات',
      },
      modelNotSupport: {
        title: 'نموذج غير مدعوم',
        desc: 'لا يوفر إصدار الإضافة المثبت هذا النموذج.',
        descForVersionSwitch: 'لا يوفر إصدار الإضافة المثبت هذا النموذج. انقر لتبديل الإصدار.',
      },
      configureModel: 'تكوين النموذج',
      notAuthorized: 'غير مفوض',
      model: 'نموذج',
      toolbox: 'صندوق الأدوات',
      strategyNotSet: 'استراتيجية الوكيل لم يتم تعيينها',
      tools: 'أدوات',
      maxIterations: 'الحد الأقصى للتكرارات',
      modelNotSelected: 'لم يتم تحديد النموذج',
      modelNotInstallTooltip: 'هذا النموذج غير مثبت',
      toolNotInstallTooltip: '{{tool}} غير مثبت',
      toolNotAuthorizedTooltip: '{{tool}} غير مفوض',
      strategyNotInstallTooltip: '{{strategy}} غير مثبتة',
      unsupportedStrategy: 'استراتيجية غير مدعومة',
      pluginNotFoundDesc: 'تم تثبيت هذه الإضافة من GitHub. يرجى الانتقال إلى الإضافات لإعادة التثبيت',
      strategyNotFoundDesc: 'لا يوفر إصدار الإضافة المثبت هذه الاستراتيجية.',
      strategyNotFoundDescAndSwitchVersion: 'لا يوفر إصدار الإضافة المثبت هذه الاستراتيجية. انقر لتبديل الإصدار.',
      modelSelectorTooltips: {
        deprecated: 'هذا النموذج مهمل',
      },
      outputVars: {
        text: 'محتوى مولد بواسطة الوكيل',
        usage: 'معلومات استخدام النموذج',
        files: {
          title: 'ملفات مولدة بواسطة الوكيل',
          type: 'نوع الدعم. الآن يدعم الصور فقط',
          transfer_method: 'طريقة النقل. القيمة هي remote_url أو local_file',
          url: 'رابط الصورة',
          upload_file_id: 'معرف ملف التحميل',
        },
        json: 'json مولد بواسطة الوكيل',
      },
      checkList: {
        strategyNotSelected: 'لم يتم تحديد الاستراتيجية',
      },
      installPlugin: {
        title: 'تثبيت الإضافة',
    ...
    knowledgeBase: {
      ...
      chunkStructureTip: {
        title: 'يرجى اختيار هيكل القطعة',
        message: 'تدعم قاعدة معارف One Health ثلاثة هياكل للتقسيم: عام، وأب-ابن، وسؤال وجواب. يمكن أن يكون لكل قاعدة معرفة هيكل واحد فقط. يجب أن يتوافق الإخراج من العقدة السابقة مع هيكل القطعة المحدد. لاحظ أن اختيار هيكل التقسيم يؤثر على طرق الفهرسة المتاحة.',
        learnMore: 'اعرف المزيد',
      },
      changeChunkStructure: 'تغيير هيكل القطعة',
      chunksInput: 'القطع',
      chunksInputTip: 'متغير الإدخال لعقدة قاعدة المعرفة هو القطع. نوع المتغير هو كائن بمخطط JSON محدد يجب أن يكون متسقًا مع هيكل القطعة المحدد.',
      aboutRetrieval: 'حول طريقة الاسترداد.',
      ...
      retrievalSettingIsRequired: 'إعداد الاسترداد مطلوب',
      rerankingModelIsRequired: 'نموذج إعادة الترتيب مطلوب',
      rerankingModelIsInvalid: 'نموذج إعادة الترتيب غير صالح',
    },
    triggerSchedule: {
      title: 'الجدول الزمني',
      nodeTitle: 'مشغل الجدول الزمني',
      notConfigured: 'غير مكون',
      useCronExpression: 'استخدام تعبير cron',
      useVisualPicker: 'استخدام منتقي مرئي',
      frequency: {
        label: 'التكرار',
        hourly: 'كل ساعة',
        daily: 'يوميًا',
      ...
      lastDayTooltip: 'لا تحتوي جميع الأشهر على 31 يومًا. استخدم خيار "اليوم الأخير" لتحديد اليوم الأخير من كل شهر.',
      mode: 'الوضع',
      timezone: 'المنطقة الزمنية',
      visualConfig: 'تكوين مرئي',
      monthlyDay: 'يوم شهري',
      ...
      invalidStartTime: 'وقت بدء غير صالح',
      startTimeMustBeFuture: 'يجب أن يكون وقت البدء في المستقبل',
      invalidTimeFormat: 'تنسيق وقت غير صالح (المتوقع HH:MM AM/PM)',
      ...
      invalidExecutionTime: 'وقت تنفيذ غير صالح',
    ...
    triggerWebhook: {
      ...
      webhookUrl: 'عنوان URL لـ Webhook',
      ...
      addParameter: 'إضافة',
      addHeader: 'إضافة',
      noParameters: 'لم يتم تكوين معلمات',
      noQueryParameters: 'لم يتم تكوين معلمات استعلام',
      noHeaders: 'لم يتم تكوين رؤوس',
      noBodyParameters: 'لم يتم تكوين معلمات جسم',
      debugUrlTitle: 'للتشغيل الاختباري، استخدم دائمًا هذا العنوان',
      debugUrlCopy: 'انقر للنسخ',
      debugUrlCopied: 'تم النسخ!',
      debugUrlPrivateAddressWarning: 'يبدو أن هذا العنوان هو عنوان داخلي، مما قد يتسبب في فشل طلبات webhook. يمكنك تغيير TRIGGER_URL إلى عنوان عام.',
      errorHandling: 'معالجة الأخطاء',
      errorStrategy: 'معالجة الأخطاء',
      responseConfiguration: 'الاستجابة',
      asyncMode: 'الوضع غير المتزامن',
      ...
      validation: {
        ...
        invalidParameterType: 'نوع معلمة غير صالح "{{type}}" للمعلمة "{{name}}"',
      },
    },
  },
  triggerStatus: {
  ...
  versionHistory: {
    ...
    filter: {
      ...
      onlyShowNamedVersions: 'عرض الإصدارات المسماة فقط',
    ...
    deletionTip: 'الحذف لا رجعة فيه، يرجى التأكيد.',
    action: {
  ...
  debug: {
    ...
    lastRunInputsCopied: 'تم نسخ {{count}} مدخل(ات) من آخر تشغيل',
    ...
    variableInspect: {
      title: 'فحص المتغير',
      emptyTip: 'بعد المرور عبر عقدة على اللوحة أو تشغيل خطوة عقدة بخطوة، يمكنك عرض القيمة الحالية لمتغير العقدة في فحص المتغير',
      emptyLink: 'اعرف المزيد',
      clearAll: 'إعادة تعيين الكل',
      clearNode: 'مسح المتغير المخزن مؤقتًا',
      ...
      listening: {
        ...
        tip: 'يمكنك الآن محاكاة مشغلات الأحداث عن طريق إرسال طلبات اختبار إلى نقطة نهاية HTTP {{nodeName}} أو استخدامها كعنوان URL لرد الاتصال لتصحيح أخطاء الأحداث الحية. يمكن عرض جميع المخرجات مباشرة في فحص المتغير.',
        tipPlugin: 'الآن يمكنك إنشاء أحداث في {{- pluginName}}، واسترداد المخرجات من هذه الأحداث في فحص المتغير.',
        tipSchedule: 'الاستماع للأحداث من مشغلات الجدول الزمني.\nالتشغيل المجدول التالي: {{nextTriggerTime}}',
        tipFallback: 'انتظار أحداث المشغل الواردة. ستظهر المخرجات هنا.',
        defaultNodeName: 'هذا المشغل',
        defaultPluginName: 'مشغل الإضافة هذا',
        defaultScheduleTime: 'غير مكون',
        selectedTriggers: 'المشغلات المحددة',
        stopButton: 'توقف',
      },
      trigger: {
        normal: 'فحص المتغير',
        running: 'تخزين حالة التشغيل مؤقتًا',
        stop: 'إيقاف التشغيل',
        cached: 'عرض المتغيرات المخزنة مؤقتًا',
        clear: 'مسح',
      },
      envNode: 'البيئة',
      chatNode: 'المحادثة',
      systemNode: 'النظام',
      exportToolTip: 'تصدير المتغير كملف',
  ...
  onboarding: {
    title: 'حدد عقدة بدء للبدء',
    description: 'تتمتع عقد البدء المختلفة بقدرات مختلفة. لا تقلق، يمكنك دائمًا تغييرها لاحقًا.',
    userInputFull: 'إدخال المستخدم (عقدة البدء الأصلية)',
    userInputDescription: 'عقدة البدء التي تسمح بتعيين متغيرات إدخال المستخدم، مع تطبيق الويب، وAPI الخدمة، وخادم MCP، وقدرات سير العمل كأداة.',
    trigger: 'مشغل',
    triggerDescription: 'يمكن أن تعمل المشغلات كعقدة بدء لسير العمل، مثل المهام المجدولة، أو webhooks المخصصة، أو التكامل مع تطبيقات أخرى.',
    back: 'عودة',
    learnMore: 'اعرف المزيد',
    aboutStartNode: 'حول عقدة البدء.',
    escTip: {
      press: 'اضغط',
      key: 'esc',
      toDismiss: 'للتجاهل',
