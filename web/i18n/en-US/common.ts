const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to One Health to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by One Health allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across One Health\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'One Health {{version}} is now available.',
    latestAvailable: 'One Health {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
