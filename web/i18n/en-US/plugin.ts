const translation = {
  ...
  marketplace: {
    ...
    discover: 'Discover',
    and: 'and',
    difyMarketplace: 'One Health Marketplace',
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by One Health',
    partnerTip: 'Verified by a One Health partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current One Health version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
