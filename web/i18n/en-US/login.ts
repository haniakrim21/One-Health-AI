const translation = {
  pageTitle: 'Log in to One Health',
  ...
  license: {
    tip: 'Before starting One Health Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on One Health',
  invalid: 'The link has expired',
  explore: 'Explore One Health',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on One Health and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The One Health Enterprise license for your workspace has expired. Please contact your administrator to continue using One Health.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect One Health license server. Please contact your administrator to continue using One Health.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The One Health Enterprise license for your workspace is inactive. Please contact your administrator to continue using One Health.',
  webapp: {
    login: 'Login',
