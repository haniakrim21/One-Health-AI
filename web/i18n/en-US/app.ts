const translation = {
  ...
  join: 'One Health AI',
  communityIntro:
    'Offers everything you need — agentic workflows, RAG pipelines, integrations, and observability — all in one place, putting AI power into your hands.',
  ...
  tracing: {
    ...
    aliyun: {
      title: 'Cloud Monitor',
      description: 'The fully-managed and maintenance-free observability platform provided by Alibaba Cloud, enables out-of-the-box monitoring, tracing, and evaluation of One Health applications.',
    },
    mlflow: {
      title: 'MLflow',
