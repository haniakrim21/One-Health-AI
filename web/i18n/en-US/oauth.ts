const translation = {
  tips: {
    loggedIn: 'This app wants to access the following information from your One Health Cloud account.',
    notLoggedIn: 'This app wants to access your One Health Cloud account',
